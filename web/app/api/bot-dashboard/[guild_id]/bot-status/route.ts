...
export async function GET(
  ...
  const invite_url =
    `https://discord.com/oauth2/authorize?client_id=1476977037070696612&permissions=8&integration_type=0&scope=bot&guild_id=${guild_id}&disable_guild_select=true`
